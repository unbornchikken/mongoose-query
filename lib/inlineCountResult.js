...
InlineCountResult.prototype.lean = function () {
    return new InlineCountResult(this.originalQuery.lean.apply(this.originalQuery, arguments), this.query);
};
...
InlineCountResult.prototype.where = function () {
    return new InlineCountResult(this.originalQuery.where.apply(this.originalQuery, arguments), this.query);
};

InlineCountResult.prototype.equals = function () {
    return new InlineCountResult(this.originalQuery.equals.apply(this.originalQuery, arguments), this.query);
};
